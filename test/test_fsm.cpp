...
const uint8_t positionPassedLeft = (END_LEFT_PLUS_OFFSET[Machine_t::Kh910] + GARTER_SLOP) + 1;
const uint8_t positionPassedRight = (END_RIGHT_MINUS_OFFSET[Machine_t::Kh910] - GARTER_SLOP) - 1;
